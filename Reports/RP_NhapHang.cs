...
{
    public partial class RP_NhapHang : UserControl
    {
        public RP_NhapHang()
        {
            InitializeComponent();
        ...
        {
            vDanhSachPNhapBindingSource.DataSource = bc.nhapnamthang(cb_Nam.Text, cb_Thang.Text);
            this.reportViewer1.RefreshReport();
        }

        private void RP_NhapHang_Load(object sender, EventArgs e)
        {
            gancombo();
        }
    }
